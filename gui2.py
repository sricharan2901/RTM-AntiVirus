#GUI Code for second Antivirus solution
import threading
from tkinter import *
...
#Function to execute the engine.exe and capture output line by line
...
#Function to Toggle between the windows
def toggle_win():
...
#Function to show back root page
def show_root():
...
#Function to show the file upload page
...
#Function to show the directory upload page
...
#Function to show the monitoring page
def show_rtm_page():
    file_upload_page.pack_forget()
    directory_upload_page.pack_forget()
    rtm_page.pack()
...
#Function to toggle the process runtime
def toggle_switch():
    global process_rtm
    if switch_var.get() == 1:
...
#Root page
my_label = Label(root, text="NotAvast", font=("Helvetica", 60, "bold"), bg="#262626", fg="white")
...
my_label = Label(rtm_page, text="Enter directory path here:", font=("Helvetica", 15, "bold"), bg="#262626", fg="White")
